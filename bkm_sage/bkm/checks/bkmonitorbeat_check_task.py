...
conf_help = "现网机器 bkmonitorbeat 配置文件相对路径，默认为 '/usr/local/gse2_paas3_dev/plugins/etc/bkmonitorbeat.conf'"
...
registry.new_proxy_actuator(
    option=registry.with_proxy_option(
        ...
        help=help,
        params=[
            registry.with_param(name="binary", type="string", default=binary_default, help=binary_help),
